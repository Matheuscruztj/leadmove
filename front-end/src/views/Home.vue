<template>
  <div class="container-center">
    ...
    <div class="top-8 relative">
      <CardComponent>
        <template #title>
          <h1 class="relative justify-center flex text-purple-800">Enviar Vídeo</h1>
        </template>
        
        <div id="upload">
          <input type="file" accept="video/*,image/*"  @change="handleFileChange" class="w-full p-2 rounded mb-4 shadow-2xl " />
          Clique para upload
        </div>
